      ...
      <div className="bg-primary/60 h-full">
        ...
        <div className='text-center h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10'>
          <div className='text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto'>
            ...
            I am a passionate and innovative front-end developer with a mission to create captivating and user-centric web experiences. 
            With a keen eye for design and a strong technical background, I thrive on turning ideas into visually stunning and highly
            functional websites. 
            </motion.p>
